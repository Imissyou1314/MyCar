...
public class AddNewCarInputModelImpl implements AddNewCarInputModel {
    ...
    @Override
    public void sentToService(CarInfoBean carInfoBean) {
        ...
        RxVolleyUtils.getInstance().postJson(url, params, callback);
    }

    @Override
    public void saveToSPU(BaseBean baseBean, String key) {
