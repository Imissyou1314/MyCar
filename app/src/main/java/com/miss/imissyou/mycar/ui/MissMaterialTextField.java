 ...
 */
public class MissMaterialTextField extends EditText {
    ...
    public MissMaterialTextField(Context context) {
        super(context);
        setup();
    }

    public MissMaterialTextField(Context context, AttributeSet attrs) {
        super(context, attrs);
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    ...
                    final ObjectAnimator bar_animator = ObjectAnimator.ofFloat(
                            MissMaterialTextField.this, "barPosition", 0f, 1.02f);
                    ...
                    final ObjectAnimator flash_animator = ObjectAnimator.ofFloat(
                            MissMaterialTextField.this, "flashPosition", 0f, 1f);
