...
import com.miss.imissyou.mycar.util.adapter.WeizhangResponseAdapter;
...
//		CarInfo car = (CarInfo) intent.getSerializableExtra("carInfo");
		CarInfo car = GsonUtils.Instance().fromJson(intent.getStringExtra("carInfo"), CarInfo.class);
