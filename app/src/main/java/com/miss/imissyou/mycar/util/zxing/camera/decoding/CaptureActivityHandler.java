...
import com.miss.imissyou.mycar.util.zxing.camera.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
    ...
    private final AddNewCarActivity activity;
    ...
    public CaptureActivityHandler(AddNewCarActivity activity, Vector<BarcodeFormat> decodeFormats,
                                  String characterSet) {
