package com.miss.imissyou.mycar.ui.sidemenu.util;
...
public class ViewAnimator<T extends Resourceble> {
    ...
    public ViewAnimator(Activity activity, List<SlideMenuItem> items, ContentFragment screenShotable, final DrawerLayout drawerLayout, ViewAnimatorListener animatorListener){
        this.activity = activity;
        this.list = (List<T>) items;
